...
class User:
    ...
    def all_scores(self, ground_truth) -> (dict(), float, int):
        ...
        score = {'ade': absolute_dis_err, 'fde': final_abs_dis_err, 'mon': min_abs_over_n_err}
    ...
    if err.code == ErrOK:
        ...
        if err.code == ErrOK:
            ...
            if err.code == ErrOK:
                ...
                print('average scores - ade: {}, fde: {}, mon: {}\n'.format(sum(score['ade'])/num_of_cases, sum(score['fde'])/num_of_cases, sum(score['mon'])/num_of_cases))
                print('worst scores - ade: {}, fde: {}, mon: {}\n'.format(max(score['ade']), max(score['fde']), max(score['mon'])))
                print('worst indices - ade: {}, fde: {}, mon: {}\n'.format(score['ade'].index(max(score['ade'])), score['fde'].index(max(score['fde'])), score['mon'].index(max(score['mon']))))
